...
export const oberflaecheBestand = {
  files: [
    ...
    "src/app/(portal)/verwaltung/abrechnung/page.tsx",
    "src/app/(portal)/verwaltung/dokument-quellen/page.tsx",
    "src/app/(portal)/verwaltung/eigentuemer/page.tsx",
    "src/app/(portal)/verwaltung/einstellungen/page.tsx",
    "src/app/(portal)/verwaltung/integrationen/page.tsx",
    "src/app/(portal)/verwaltung/kontakte/KontaktAnlegen.tsx",
    "src/app/(portal)/verwaltung/kontakte/page.tsx",
    "src/app/(portal)/verwaltung/nutzer/page.tsx",
    "src/app/(portal)/verwaltung/nutzer/person-einstellungen.tsx",
    "src/app/(portal)/verwaltung/objekte/\\[id\\]/bearbeiten/page.tsx",
    "src/app/(portal)/verwaltung/objekte/neu/ObjektForm.tsx",
    "src/app/(portal)/verwaltung/objekte/page.tsx",
