    ...
    <>
      ...
      <Card title="Alle Schritte">
        ...
        <p className="mt-4 border-t border-gray-100 pt-3 text-xs text-gray-400">
          Die Reihenfolge ist nicht willkürlich: Jeder Schritt braucht den
          vorherigen. Ohne Kostenarten lässt sich kein Wirtschaftsplan
          aufstellen, ohne beschlossenen Plan entstehen keine
          Hausgeld-Forderungen.
        </p>
      </Card>
    </>
  );
