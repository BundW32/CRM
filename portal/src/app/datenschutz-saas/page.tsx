    ...
    <LegalPage
      ...
      intro={
        <p>
          ...
          <span className="mt-2 block text-gray-500">Stand: 12. September 2026</span>
        </p>
      }
    >
      ...
      <LegalSection title="4. Eingesetzte Dienstleister">
        <p>
          ...
          Freischaltung durch den Kunden anlaufen: Google (Gemini API) für die fünf
          optionalen KI-Funktionen — Assistent, Vorqualifizierung eingehender Meldungen,
          Objekt-Import aus PDF, Kostenart-Vorschlag beim Bankimport und Belegerkennung
          beim Erfassen einer Rechnung —, Google Drive
