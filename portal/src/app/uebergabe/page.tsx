                ...
                return (
                  ...
                  >
                    ...
                    <div className="px-4 py-3 bg-gray-50 flex items-center justify-between gap-2">
                      ...
                      <a
                        href={resumeHref(h)}
                        className="inline-flex items-center justify-center rounded-lg bg-brand-orange px-3 py-1.5 text-xs font-semibold text-brand-green-dark shadow-sm transition-all hover:bg-brand-orange-dark active:scale-95"
                      >
                        Fortsetzen →
                      </a>
                    </div>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      {h.pdfStoredName && (
                        <a
                          ...
                          className="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-medium text-gray-700 transition-all hover:bg-gray-50 active:scale-95"
                        >
