...
export const AUDIT = {
  ...
  WEG_STATEMENT_DOCUMENTS_RETRIED: "WEG_STATEMENT_DOCUMENTS_RETRIED",
  WEG_DUE_POSTINGS_EXTENDED: "WEG_DUE_POSTINGS_EXTENDED",
  WEG_PLAN_SAVED: "WEG_PLAN_SAVED",
  WEG_PLAN_DELETED: "WEG_PLAN_DELETED",
  WEG_PLAN_RESOLVED: "WEG_PLAN_RESOLVED",
  WEG_PLAN_DOCUMENTS_RETRIED: "WEG_PLAN_DOCUMENTS_RETRIED",
  WEG_PAYMENT_ASSIGNED: "WEG_PAYMENT_ASSIGNED",
  WEG_PAYMENT_ALLOCATED: "WEG_PAYMENT_ALLOCATED",
  WEG_PAYMENT_ALLOCATION_CLEARED: "WEG_PAYMENT_ALLOCATION_CLEARED",
  ...
  WEG_VERBINDLICHKEIT_SAVED: "WEG_VERBINDLICHKEIT_SAVED",
  WEG_VERBINDLICHKEIT_SETTLED: "WEG_VERBINDLICHKEIT_SETTLED",
  WEG_VERBINDLICHKEIT_DELETED: "WEG_VERBINDLICHKEIT_DELETED",
  WEG_VERBINDLICHKEIT_IMPORTED: "WEG_VERBINDLICHKEIT_IMPORTED",
  WEG_BAUABZUG_ANGEMELDET: "WEG_BAUABZUG_ANGEMELDET",
